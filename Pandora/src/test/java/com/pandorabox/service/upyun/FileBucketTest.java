...
public class FileBucketTest extends BasePandoraServiceTest{
	...
	private static UpYunService upyun = null;
	...
	public static void main(String[] args) throws Exception {
		...
		// 初始化空间
		upyun = new UpYunService(BUCKET_NAME, USER_NAME, USER_PWD);
	...
	public static void testWriteFile() throws IOException {
		...
		upyun.setContentMD5(UpYunService.md5(file4));
	...
	public static void testReadDir() {
		...
		List<UpYunService.FolderItem> items = upyun.readDir(dirPath);
